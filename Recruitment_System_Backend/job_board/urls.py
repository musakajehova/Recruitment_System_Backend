...
urlpatterns= [
    ...
    path( 'person/admin_view/', AdminPersonsView.as_view(), name='adminPersonView_create'),         #Returns all the Persons records
    path( 'person/admin_view/<int:pk>/', AdminPersonsUpdate.as_view(), name='adminPerson_create'),    #Retrieve Update a singel record
